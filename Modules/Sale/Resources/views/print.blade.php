        ...
        <div class="col-xs-12">
            ...
            <div class="card" style="background-color: transparent !important;">
                <div class="card-body"  style="background-color: transparent !important;">
                    ...
                    <div class="table-responsive-sm" style="margin-top: 30px; background: url('{{ public_path('images/opacity2.png') }}') !important; background-size: 100% !important;  background-position: center !important; background-repeat: round !important; ">
