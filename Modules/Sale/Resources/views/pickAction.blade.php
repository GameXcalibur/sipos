...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('pick.index') }}">Pick</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="pick-form" action="{{ route('pick.complete', $sale) }}" method="POST">
                        @csrf
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @php
                                    $sortedDetails = $sale->saleDetails->sortBy('product_name');
                                    @endphp
                                @foreach($sortedDetails as $item)
                                    <tr>
...
if(!is_checked){
    ...
    Swal.fire({
      title: 'PICK SIGN OFF DISCLAIMER',
              html: "Please ensure that you have picked accurately according to the invoice. By accepting this disclaimer, you hereby guarantee that you have not mis-picked nor have you misplaced any product associated with the invoice.",
              icon: 'warning',
